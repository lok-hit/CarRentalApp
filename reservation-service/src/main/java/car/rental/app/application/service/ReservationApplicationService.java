...
import car.rental.app.application.exception.ReservationAlreadyCancelledException;
import car.rental.app.application.exception.ReservationAlreadyConfirmedException;
import car.rental.app.application.exception.ReservationNotFoundException;
...
import car.rental.app.domain.port.ReservationRepository;
...
public class ReservationApplicationService {
    ...
    private void publishDomainEvents(Reservation reservation) {
        for (DomainEvent event : reservation.drainDomainEvents()) {
            log.info("Publishing car_rental_app.domain event {}", event.getClass().getSimpleName());
