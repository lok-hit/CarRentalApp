...
class PaymentFailedIntegrationTest extends BaseIntegrationTest {

    @Autowired
    OutboxEventRepository repository;

    @Test
    void shouldHandlePaymentFailedEventAndPublishRollbackEventToKafka() throws Exception {
        ...
        Awaitility.await().atMost(Duration.ofSeconds(10))
                .untilAsserted(() -> {
                    ConsumerRecord<String, String> recorded = KafkaTestUtils.getSingleRecord(consumer, "reservation-events");
