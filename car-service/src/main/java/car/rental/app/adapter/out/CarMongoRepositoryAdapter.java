...
public class CarMongoRepositoryAdapter implements CarRepository {
     ...
     *
     * @return a list of car_rental_app.domain Car objects with status AVAILABLE; an empty list if none are found
     */
    @Override
    @Transactional(readOnly = true)
     ...
     *
     * @param car the car_rental_app.domain Car to persist
