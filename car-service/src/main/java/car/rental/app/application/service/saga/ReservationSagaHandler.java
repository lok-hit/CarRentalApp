package car.rental.app.application.service.saga;
...
public class ReservationSagaHandler {
    ...
    public void onReservationConfirmed(ReservationConfirmedEvent event) {
        try {
            ...
            log.info("[traceId={}] Saga END: onReservationConfirmed OK reservationId={}" + event.getReservationId());
                         ...
                         throw new SagaException("Saga failed to process reservation confirmation. " +
                    "ReservationId: " + event.getReservationId() + 
                    " CarId: " + event.getCarId(), ex);
        }
    }
    ...
    public void onPaymentConfirmed(PaymentConfirmedEvent event) {
        ...
        try {
            ...
            throw new SagaException("Saga failed to process payment confirmation. " +
                    "ReservationId: " + event.getReservationId() + 
