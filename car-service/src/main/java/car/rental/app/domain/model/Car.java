...
public class Car {
    ...
    /**
     * Updates the car's price and appends a CarPriceChangedEvent to the car_rental_app.domain event list.
     *
    ...
    /**
     * Provides and clears the car's queued car_rental_app.domain events.
     *
     * Returns an immutable copy of the current car_rental_app.domain events and clears the internal event list so subsequent calls will not return the same events.
     *
