...
public class OutboxEventPublisher {
    ...
    public void publishPendingEvents() {
        List<car_rental_app.adapter.out.messaging.outbox.OutboxEventDocument> pending = repository.findByStatus("PENDING");
        ...
        for (car_rental_app.adapter.out.messaging.outbox.OutboxEventDocument doc : pending) {
            try {
